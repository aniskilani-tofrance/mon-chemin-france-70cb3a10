...
export const ONBOARDING_TREE: DecisionTree = {
  ...
  questions: {
    ...
    location: {
      ...
      subtitle: {
        fr: "Nom de votre ville (ex : Lyon, Paris, Marseille)",
        en: "Your city name (e.g., Lyon, Paris, Marseille)",
        ar: "اسم مدينتك (مثال: ليون، باريس، مرسيليا)",
        es: "Nombre de tu ciudad (ej: Lyon, París, Marsella)",
        pt: "Nome da sua cidade (ex: Lyon, Paris, Marselha)",
        it: "Nome della tua città (es: Lione, Parigi, Marsiglia)",
        de: "Name Ihrer Stadt (z.B.: Lyon, Paris, Marseille)",
        tr: "Şehrinizin adı (ör: Lyon, Paris, Marsilya)",
        pl: "Nazwa twojego miasta (np.: Lyon, Paryż, Marsylia)",
        vi: "Tên thành phố của bạn (ví dụ: Lyon, Paris, Marseille)",
        zh: "您的城市名称（例如：里昂、巴黎、马赛）",
        ru: "Название вашего города (например: Лион, Париж, Марсель)",
        uk: "Назва вашого міста (наприклад: Ліон, Париж, Марсель)",
        fa: "نام شهر شما (مثلاً: لیون، پاریس، مارسی)",
        bn: "আপনার শহরের নাম (যেমন: লিয়ন, প্যারিস, মার্সেই)",
        ur: "آپ کے شہر کا نام (مثلاً: لیون، پیرس، مارسیلے)",
      },
      required: true,
