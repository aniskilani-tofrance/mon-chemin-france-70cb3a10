...
export const ONBOARDING_TREE: DecisionTree = {
  ...
  questions: {
    ...
    location: {
      ...
      subtitle: {
        fr: "Adresse complète : numéro, rue, ville (ex: 12 rue de la Paix, Paris)",
        en: "Full address: number, street, city (e.g., 12 Peace Street, Paris)",
        ar: "العنوان الكامل: الرقم، الشارع، المدينة",
        es: "Dirección completa: número, calle, ciudad (ej: 12 calle de la Paz, Madrid)",
        pt: "Endereço completo: número, rua, cidade (ex: 12 Rua da Paz, Lisboa)",
        it: "Indirizzo completo: numero, via, città",
        de: "Vollständige Adresse: Hausnummer, Straße, Stadt",
        tr: "Tam adres: numara, sokak, şehir",
        pl: "Pełny adres: numer, ulica, miasto",
        vi: "Địa chỉ đầy đủ: số, đường, thành phố",
        zh: "完整地址：门牌号、街道、城市",
        ru: "Полный адрес: номер дома, улица, город",
        uk: "Повна адреса: номер, вулиця, місто",
        fa: "آدرس کامل: شماره، خیابان، شهر",
        bn: "সম্পূর্ণ ঠিকানা: নম্বর, রাস্তা, শহর",
