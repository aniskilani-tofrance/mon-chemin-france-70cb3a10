  ...
  questions: {
    ...
    main_goal: {
      ...
      question: {
        ...
        tr: "Ana hedefiniz nedir?",
        pl: "Jaki jest Twój główny cel?",
        vi: "Mục tiêu chính của bạn là gì?",
        zh: "你的主要目标是什么？",
        ru: "Какова ваша главная цель?",
        uk: "Яка ваша головна мета?",
        fa: "هدف اصلی شما چیست؟",
        bn: "আপনার প্রধান লক্ষ্য কি?",
        ur: "آپ کا بنیادی مقصد کیا ہے؟",
      },
      choices: [
        {
          id: "learn_french",
        ...
        },
        {
          ...
          label: {
            ...
            it: "Non so / ho bisogno di aiuto",
            de: "Ich weiß nicht / brauche Hilfe",
            tr: "Bilmiyorum / yardıma ihtiyacım var",
            pl: "Nie wiem / potrzebuję pomocy",
            vi: "Tôi không biết / cần giúp đỡ",
            zh: "我不知道 / 需要帮助",
            ru: "Не знаю / нужна помощь",
            uk: "Не знаю / потрібна допомога",
            fa: "نمی‌دانم / نیاز به کمک دارم",
            bn: "জানি না / সাহায্য দরকার",
            ur: "نہیں معلوم / مدد چاہیے",
          },
          icon: "🤝",
      ...
      choices: [
        {
          ...
          label: {
            ...
            it: "Sì, sono disponibile",
            de: "Ja, ich bin verfügbar",
            tr: "Evet, müsaitim",
            pl: "Tak, jestem dostępny",
            vi: "Có, tôi sẵn sàng",
            zh: "是的，我有空",
            ru: "Да, я доступен",
            uk: "Так, я доступний",
            fa: "بله، در دسترس هستم",
            bn: "হ্যাঁ, আমি উপলব্ধ",
            ur: "ہاں، میں دستیاب ہوں",
          },
          icon: "✅",
        ...
        },
        {
          ...
          label: {
            ...
            it: "No, non adesso",
            de: "Nein, nicht jetzt",
            tr: "Hayır, şu anda değil",
            pl: "Nie, teraz nie",
            vi: "Không, không phải bây giờ",
            zh: "不，现在不行",
            ru: "Нет, не сейчас",
            uk: "Ні, не зараз",
            fa: "نه، الان نه",
