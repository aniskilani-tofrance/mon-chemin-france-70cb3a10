...
export const questions: PlacementQuestion[] = [
  ...
  { id: 43, level: "B2", category: "Compréhension Orale", question: "Quelle est l'opinion de la personne ?", audioText: "À mon avis, cette réforme est nécessaire mais elle devrait être mise en place progressivement.", options: ["Elle est contre", "Elle est pour sans conditions", "Elle est pour mais avec prudence", "Elle n'a pas d'opinion"], correct: "Elle est pour mais avec prudence" },
