...
export default function Login() {
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.auth.resetPasswordForEmail(email, {
        redirectTo: `https://tofrance.app/reset-password`,
      });
      if (error) throw error;
      setResetSent(true);
  ...
  if (mode === "reset") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted p-4">
        <SEO title="Réinitialiser le mot de passe" description="Réinitialisez votre mot de passe ToFrance." path="/login" />
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted p-4">
      <SEO title="Connexion" description="Connectez-vous à votre compte ToFrance." path="/login" />
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
